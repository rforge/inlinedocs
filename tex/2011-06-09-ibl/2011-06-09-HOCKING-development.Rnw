...
\begin{frame}
\frametitle{How do the R-Core developers manager their code?}
\begin{tabular}{ll}
  \coreforge{Email lists}{r-help@r-project.org}{
  ...
  \hline
  \coreforge{Bug tracking website}{https://bugs.r-project.org}{
