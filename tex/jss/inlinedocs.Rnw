...
documentation specified in \R\ code, and the Sweave system
...
and and updates the generated documentation automatically. S4 class
...
object in the package.  The generated Rd files should be treated as
